...
PORT=`grep -Po '"port":"\K\d*' /home/pi/sshtunnel/config/local.json`
HOST=`grep -Po '"host":"\K[\w\.-]*' /home/pi/sshtunnel/config/local.json`
USER=`grep -Po '"user":"\K[\w\.-]*' /home/pi/sshtunnel/config/local.json`
